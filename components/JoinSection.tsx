  ...
  return (
    <section id='join-us' className='flex-center my-28'>
        <div className='flex-center flex-col gap-6 text-center text-white relative'>
            <Image src="/bitcoin.png" width={75} height={75} alt='bitcoin' className='md:flex hidden float absolute top-[100px] left-[-100px]' />
            <h2 className='text-[52px] md:text-[72px] lg:text-[96px] font-bold  uppercase leading-[1.25]'>Join us via <br /><span className='text-gradient_purple-blue mt-2'>Discord</span></h2>
            ...
            <Image src="/ethereum.png" width={75} height={75} alt='bitcoin' className='hidden md:flex float absolute top-[100px] right-[-100px]' />
        </div>
    </section>
  )
}
